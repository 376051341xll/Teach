...
$partner		= "2088702402324253";

//安全检验码，以数字和字母组成的32位字符
$key   			= "7p4za50iq97f2tgll1xejhzj766u0rmy";

//签约支付宝账号或卖家支付宝帐户
$seller_email	= "xie_wengui@yeah.net";

//交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
$notify_url		= "http://www.bandit6.com/pay/notify_url.php";

//付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
//return_url的域名不能写成http://localhost/js_php_utf8/return_url.php ，否则会导致return_url执行无效
$return_url		= "http://www.bandit6.com/pay/return_url.php";

//网站商品的展示地址，不允许加?id=123这类自定义参数
$show_url		= "http://www.bandit6.com";
