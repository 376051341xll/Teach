...
//必填参数
$out_trade_no = "Z".date(Ymdhms);	//请与贵网站订单系统中的唯一订单号匹配
$subject      = "会员充值";	//订单名称，显示在支付宝收银台里的“商品名称”里，显示在支付宝的交易管理的“商品名称”的列表里。
$body         = "会员充值";	//订单描述、订单详细、订单备注，显示在支付宝收银台里的“商品描述”里
$total_fee    = $_POST['amount'];	//订单总金额，显示在支付宝收银台里的“应付总额”里

// 添加支付记录到数据库
$_POST["away"]="支付宝";
$_POST["memberid"]=$_POST["memberid"];
$_POST["amount"]=$total_fee;
$_POST["recordno"]=$out_trade_no;
