<html>
	...
	<meta http-equiv="refresh" content="3;url=http://www.bandit6.com/user_jlcx.php">
<?php
/*
...
if($verify_result) {//验证成功
    ...
    if($_GET['trade_status'] == 'TRADE_FINISHED' || $_GET['trade_status'] == 'TRADE_SUCCESS') {
		//判断该笔订单是否在商户网站中已经做过处理（可参考“集成教程”中“3.4返回数据处理”）
			...
			//如果有做过处理，不执行商户的业务程序
			//$_POST["atype"] = 1;
//			$classData = $bw->selectOnly('memberid,atype' ,'bw_moneyrecord', "recordno = '".$_GET['out_trade_no']."'");
//			if($classData["atype"]!=1)
//			{
//            $bw->update('bw_moneyrecord', $_POST, "recordno = '".$_GET['out_trade_no']."'");
//			unset($_POST);
...
//			$_POST["money"]=$mclassData['money']+$_GET['total_fee'];
//			$bw->update('bw_member', $_POST, "id = ".$classData['memberid']);
//			}
    }
    else {
     // echo "trade_status=".$_GET['trade_status'];
			//$_POST['recordno']=$dingdan;
	  echo "支付失败！";
    }
