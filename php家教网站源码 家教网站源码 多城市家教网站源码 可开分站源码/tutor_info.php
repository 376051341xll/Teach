...
function yanz()
{
	...
	if(document.getElementById("jiaolin").value=="")
	{	
	document.getElementById("jiaolin").focus();
	alert("请选择您的教龄");
	return false;
	}
	if(document.getElementById("rzxxlb").value=="")
	{	
	document.getElementById("rzxxlb").focus();
	alert("请选择您的任职学校类别");
	return false;
	}
	if(document.getElementById("rjxk").value=="")
	{	
	document.getElementById("rjxk").focus();
	alert("请填写您的任教学科");
	return false;
	}
			   ...
			   <div id="all_main_all_box_left_mid">
			        <div id="tutor_box">
					  ...
					  <div id="tutor_box_center" style="width:668px; padding:1px; border:1px #f4f4f4 solid;">
					    <form onSubmit="return yanz();" action="tutor_infoto.php" method="post">
						...
						<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td width="107" height="30" align="right">真实姓名：</td>
                            <td colspan="5"><label>
                              <input name="truename" type="text" class="tutor_input" id="truename" onKeyUp="value=value.replace(/[^\u4E00-\u9FA5]/g,'')">
                              <span style="color:#F00">*请与证件上的姓名相符合，否则将不能通过认证</span></label></td>
                          </tr>
                          <tr>
                            ...
                            <td width="81" align="right">出生年份：</td>
                            <td width="114"><select name="birthday" id="birthday">
                              <option>--请选择--</option>
                              <?php
							  $nian1="20".date("y");
							  $xiao=$nian1-70;
							//  echo $nian1;
                             for($nian=$xiao;$nian<$nian1;$nian++)
							  {
							  ?>
                              <option value="<?php echo $nian;?>"><?php echo $nian;?></option>
                              <?php
                              }
							  ?>
                            </select><span style="color:#F00">&nbsp;*</span></td>
                            <td width="62" align="right">目前学历：</td>
                            <td width="194"><select name="xueli" id="xueli">
                              <option>--请选择--</option>
          <?php
...
{  ?>
			  ...
			  ?>
                          ...
                          <tr>
                            <td height="30" align="right">出生地省份：</td>
...
{  ?>
			  ...
			  ?>
                          ...
                          <tr>
                            <td height="30" align="right">区&nbsp;&nbsp; 域：</td>
...
{  ?>
			  ...
			  ?>
                            ...
                            <td align="right">教&nbsp;&nbsp;&nbsp;龄：</td>
                            <td><select name="jiaolin" id="jiaolin">
...
{  ?>
			  ...
			  ?>
                          ...
                          <tr>
                            <td height="30" align="right">任教学科：</td>
                            <td height="25" colspan="5"><input name="rjxk" type="text" class="tutor_inputs" id="rjxk"><span style="color:#F00">&nbsp;*</span></td>
                          </tr>
                          <tr>
                            <td height="30" align="right">专&nbsp;&nbsp;&nbsp;业：</td>
                            <td height="25" colspan="5"><input name="zhuanye" type="text" class="tutor_input" id="zhuanye" onKeyUp="value=value.replace(/[^\u4E00-\u9FA5]/g,'')"><span style="color:#F00">&nbsp;*必须是中文</span></td>
                          </tr>
                          <tr>
                            <td height="30" align="right">身份证 / 护照：</td>
                            <td height="25" colspan="5"><input name="idcode" type="text" class="tutor_input" id="idcode"><span style="color:#F00">&nbsp;*旧身份证为15位数字，新身份证为18位数字</span>
                           </td>
                          </tr>
                          <tr>
                            <td height="30" align="right">毕业 / 就读高校：</td>
                            <td height="25" colspan="5"><input name="xuexiao" type="text" class="tutor_inputs" id="xuexiao"><span style="color:#F00">&nbsp;*</span></td>
                          </tr>
                          <tr>
                            <td height="30" align="right">最后任职学校：</td>
                            <td height="25" colspan="5"><input name="zhrzxx" type="text" class="tutor_inputs" id="zhrzxx"></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td height="30" align="right">Q&nbsp;&nbsp;&nbsp;&nbsp;Q：</td>
                          ...
                          <tr>
                            <td height="30" align="right"> <label>地&nbsp;&nbsp;&nbsp;址：</label></td>
                            <td colspan="5"><label>
