...
?>
  <tr>
    ...
    <td align="center"><a href="bbsadd.php?id=<?php echo $list[$i]['id']; ?>"><img src="images/pen.gif" /></a>&nbsp;&nbsp;<a href="?action=delete&id=<?php echo $list[$i]['id']; ?>"><img src="images/delete.gif" /></a>&nbsp; <a href="bbspl.php?bbsid=<?php echo $list[$i]['id']; ?>">详细信息</a> </td>
  </tr>
<?php
	}//end loop
?>
