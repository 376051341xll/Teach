...
<table width="788" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="right">辅导机构:</td>
    <td>&nbsp;</td>
    <td><input name="author" class="textBox" id="author" value="<?php if(empty($newsData['author'])){echo 成都英海航教育;}else{echo $newsData['author']; } ?>" /></td>
  </tr>
  <tr>
    <td align="right">信息来源:</td>
    <td>&nbsp;</td>
    <td><input name="froms" class="textBox" id="froms" value="<?php if(empty($newsData['from'])){ echo '成都英海航教育';}else{ echo $newsData['froms']; } ?>" /></td>
  </tr>
  <tr>
