...
<script type="text/javascript">
	$(document).ready(function(){
		...
		location.href="fudaobanlist.php?page="+thisPage.val();
		});//end page_SEL 		
	});
</script>
</head>
...
<?php
  ...
  if(!empty($_GET['action']) && $_GET['action'] == 'search')
  {
	  ...
	  {
		$where = "title LIKE '%".$_POST['keyword']."%' AND classId = '".$_POST['classId']."' and classId='12'";
		$_SESSION['wherenews'] = $where;
	  }else if(!empty($_POST['classId'])){
		$where = "classId = '".$_POST['classId']."' and classId='12'";
		$_SESSION['wherenews'] = $where;
	  }else{
		$where = "title LIKE '%".$_POST['keyword']."%' and classId='12'";  
		$_SESSION['wherenews'] = $where;
	  }
  }else{
       $where = "classId='12'";
...
?>
  <tr>
    ...
    <td align="center"><a href="fudaobanadd.php?id=<?php echo $list[$i]['id']; ?>"><?php echo $list[$i]['title']; ?></a></td>
    <td align="center">
    	<?php
			//selectOnly($param,$tbname,$where,$order)
    ...
    <td align="center"><a href="fudaobanadd.php?id=<?php echo $list[$i]['id']; ?>"><img src="images/pen.gif" /></a>&nbsp;&nbsp;<a href="?action=delete&id=<?php echo $list[$i]['id']; ?>"><img src="images/delete.gif" /></a></td>
  </tr>
<?php
	}//end loop
?>
