...
<form id="form1" name="form1" method="post" action="?add=yes">
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td height="30" colspan="7" align="left" valign="middle" bgcolor="#FFFFFF"><textarea name="beizhu" cols="60" rows="5" id="beizhu" style="width:100%;"><?php echo $classData['beizhu'];?></textarea></td>
    </tr>
    <tr>
      <td height="30" align="center" bgcolor="#f9f9f9"><b>学员编号：</b></td>
      <td bgcolor="#FFFFFF"><?php echo $classData['id'];?>
        <input name="lang" type="hidden" id="lang" value="<?php if($classData['lang']==""){echo $Lang;}else{echo $classData['lang'];}?>" />
      <input name="username" type="hidden" id="username" value="<?php echo $_SESSION['username'];?>" /></td>
      <td align="center" bgcolor="#f9f9f9"><b>姓名：</b></td>
      <td bgcolor="#FFFFFF"><input name="name" type="text" id="name" value="<?php echo $classData['name'];?>" /></td>
      ...
      <td bgcolor="#FFFFFF"><input name="tel" type="text" id="tel" value="<?php echo $classData['tel'];?>"/></td>
    </tr>
    <tr>
...
{  ?>
    ...
    <tr>
      <td height="30" align="center" bgcolor="#f9f9f9"><strong>信息来源：</strong></td>
      <td bgcolor="#FFFFFF"><select name="xyxxly" id="xyxxly">
...
{  ?>
      ...
      <td align="center" bgcolor="#f9f9f9"><strong>报酬：</strong></td>
      ...
      <td align="right" bgcolor="#F9F9F9"><strong>信息费：</strong></td>
      <td bgcolor="#FFFFFF"><input name="xxf" type="text" id="xxf" value="<?php echo $classData['xxf'];?>"/></td>
    </tr>
    <tr>
      <td height="30" align="center" bgcolor="#f9f9f9"><strong>发布时间：</strong></td>
      <td bgcolor="#FFFFFF"><input name="addtime" id="addtime" value="<?php if(empty($classData['addtime'])){echo date("Y-m-d H:i:s", mktime()); }else{ echo $classData['addtime']; } ?>" /></td>
      <td align="center" bgcolor="#f9f9f9"><strong>到期时间：</strong></td>
      <td bgcolor="#FFFFFF"><input type="text" value="<?php echo $classData['dqsj']; ?>" name="dqsj" id="dqsj" onfocus="showCalendar(this)" style="width:100px;" readonly="readonly"/></td>
      <td align="center" bgcolor="#f9f9f9"><strong>是否显示：</strong></td>
      ...
      <td align="right" bgcolor="#F9F9F9"><strong>发布人：</strong></td>
      <td bgcolor="#FFFFFF"><?php echo $classData['username'];?></td>
    </tr>
    <tr>
      <td height="30" align="center" bgcolor="#f9f9f9"><strong>首页推荐：</strong></td>
      <td bgcolor="#FFFFFF"><select name="sftj">
      ...
      <td align="center" bgcolor="#f9f9f9"><strong>是否会员：</strong></td>
      <td bgcolor="#FFFFFF"><select name="sfhy">
      ...
      <td align="center" bgcolor="#f9f9f9"><b>状态：</b></td>
      <td bgcolor="#FFFFFF"><select name="zt">
       ...
       <option <?php if($classData['zt']=="已安排"){echo "selected='selected'";}?> value="已安排">已安排</option>
      <option <?php if($classData['zt']=="成功"){echo "selected='selected'";}?> value="成功">成功</option>
      </select></td>
    ...
    <tr>
      ...
      <td colspan="7" bgcolor="#FFFFFF"><input name="adds" type="text" id="adds" value="<?php echo $classData['adds'];?>" style="width:100%"/></td>
    </tr>
    <tr>
      <td height="30" align="center" bgcolor="#f9f9f9"><b>学员状况：</b></td>
      <td colspan="7" bgcolor="#FFFFFF"><textarea name="xyzk" style="width:100%" rows="5" id="xyzk"><?php echo $classData['xyzk'];?></textarea></td>
    </tr>
    <tr>
      <td height="30" align="center" bgcolor="#f9f9f9"><b>授课安排：</b></td>
      <td colspan="7" bgcolor="#FFFFFF"><textarea name="skap" style="width:100%" rows="5" id="skap"><?php echo $classData['skap'];?></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="7" bgcolor="#FFFFFF"><input name="gqlx" type="text" id="gqlx" style="width:100%" value="<?php echo $classData['gqlx'];?>"/></td>
    </tr>
    <tr>
      <td height="30" align="center" bgcolor="#f9f9f9"><b style="color:#ff621a">教员要求：</b></td>
      <td colspan="7" bgcolor="#FFFFFF">&nbsp;<input name="id" type="hidden" id="id" value="<?php echo $classData['id'];?>"/><input name="memo" type="hidden" id="memo" value="<?php echo $classData['memo'];?>"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="7" bgcolor="#FFFFFF"><label>
        <textarea name="qtyq" style="width:100%" rows="5" id="qtyq"><?php echo $classData['qtyq'];?></textarea>
      </label></td>
    </tr>
	<tr>
