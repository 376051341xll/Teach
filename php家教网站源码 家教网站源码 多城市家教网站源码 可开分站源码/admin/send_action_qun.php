...
$_POST["mobile"]=str_replace("，",",",$_POST["mobile"]);
if(substr($_POST["mobile"],0,1)==",")
{
$_REQUEST['mobile']=substr($_POST["mobile"],1);
}
if(substr($_POST["mobile"],-1)==",")
{
$_REQUEST['mobile']=substr($_POST["mobile"],0,-1);
}
//die($_REQUEST['mobile']);
...
if (!$err=$client->getError()) {
    echo "<script>alert('短信发送成功！');window.location='sendsms_qun.php';</script>";
    //print_r($str);
} else { 
    echo " 错误 :",$err;
}
