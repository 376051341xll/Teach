...
<table width="1030" cellspacing="0" cellpadding="0">
  ...
  <?php
	...
	htqx("10.2");
		...
		{
			$bw->msg('新增成功!', 'newsclass.php');	
		}else{
			$bw->msg('新增失败!', 'newsclass.php');	
		}
	}
  ...
  //update($tbName, $post, $where)
	...
	htqx("10.3");
		...
		if(!empty($_POST['className']))
		{
			...
			{
				$bw->msg('更新成功!', 'newsclass.php');	
			}else{
				$bw->msg('更新失败!', 'newsclass.php');	
			}
		}else{
			$bw->msg('要修改的类别名称不能为空!', 'newsclass.php');	
		}
	}
  ?>
  ...
  <?php
	...
	htqx("10.4");
		...
		if($id > 12)
		{
			...
			{
				$bw->msg('删除成功!', 'newsclass.php');	
			}else{
				$bw->msg('删除失败!', 'newsclass.php');	
			}
		}else{
			$bw->msg('系统默认分类不能删除', 'newsclass.php');	
		}
	}
  ?>
