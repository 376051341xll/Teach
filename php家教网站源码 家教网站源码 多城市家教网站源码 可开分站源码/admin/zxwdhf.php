...
<script type="text/javascript">
	$(document).ready(function(){
		...
		location.href="zxwdhf.php?page="+thisPage.val();
		});//end page_SEL 		
	});
</script>
</head>
...
<table width="96%" cellpadding="0" cellspacing="0">
  <tr class="trTitle">
    ...
    <td width="271" align="center"><strong>标&nbsp;&nbsp; 题</strong></td>
    <td width="271" align="center"><strong>内&nbsp; 容</strong></td>
    <td width="153" align="center"><strong>发件人</strong></td>
    <td width="181" align="center"><strong>发件时间</strong></td>
...
<?php
  ...
  if(!empty($_GET["hfid"]))
  {
		$where = "hfid=".$_GET['hfid'];
		$_SESSION['wherezxwdhf']=$where;
	  }
  ...
  $list = $bw->selectPage("*",$tbName,$_SESSION['wherezxwdhf'],"`id` DESC",$pageSize);
  $pageArray = $bw->requestPage($tbName,$_SESSION['wherezxwdhf'],$pageSize);
  $sum = count($list);
  for($i = 0; $i<$sum; $i++)
  {
?>
  <tr>
    ...
    <td align="center"><a href="../zxwd.php?id=<?php echo $list[$i]['title']; ?>" target="_blank"><?php echo $list[$i]['content']; ?></a></td>
    <td align="center"><a href="../zxwd.php?id=<?php echo $list[$i]['hfid']; ?>" target="_blank"><?php echo $list[$i]['content']; ?></a></td>
    <td align="center">
    	<?php echo $list[$i]['username']; ?>
    </td>
    <td align="center"><?php echo $list[$i]['addtime']; ?></td>
    <td align="center"><a href="xyadd.php?id=<?php echo $list[$i]['id']?>"><img src="images/pen.gif" alt="回复" title="回复" /></a>&nbsp; &nbsp; <a href="?action=delete&id=<?php echo $list[$i]['id']; ?>"><img src="images/delete.gif" /></a></td>
  </tr>
<?php
	}//end loop
?>
