...
<script type="text/javascript">
	$(document).ready(function(){
		...
		location.href="newslist.php?page="+thisPage.val();
		});//end page_SEL 		
	});
</script>
</head>
...
?>
  <tr>
    ...
    <td align="center"><a href="newsadd.php?id=<?php echo $list[$i]['id']; ?>"><?php echo $list[$i]['title']; ?></a></td>
    <td align="center">
    	<?php
			//selectOnly($param,$tbname,$where,$order)
    ...
    <td align="center"><a href="newsadd.php?id=<?php echo $list[$i]['id']; ?>"><img src="images/pen.gif" /></a>&nbsp;&nbsp;<a href="?action=delete&id=<?php echo $list[$i]['id']; ?>"><img src="images/delete.gif" /></a></td>
  </tr>
<?php
	}//end loop
?>
