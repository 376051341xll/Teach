...
<table width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><input type="text" name="username" id="username" value="<?php echo $newsData['username']; ?>" />
...
{  ?>
    ...
    <td><input type="text" name="Money" id="Money" value="0" /></td>
...
?>>
  ...
  <tr>
    ...
    <td colspan="7" align="left"><textarea name="xsyq" id="xsyq" cols="45" rows="5" style="width:100%; line-height:20px;">执行宁波家教网薪水标准！</textarea></td>
  </tr>
  <tr>
