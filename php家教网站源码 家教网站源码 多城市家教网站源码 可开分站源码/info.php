...
<div id="about_main_all">
	 ...
	 <div id="about_main_all_box">
	      <div id="about_main_all_box_left">
		       <div id="about_main_all_box_left_top">当前位置：服务专栏</div>
					...
					<div id="mid">
						 ...
						 <div id="dh">
							<?php
								...
								$classList = $bw->selectMany("id,title","bw_base","classId=5","`id` ASC");
								//var_dump($classList);
								//exit;
							...
							?>
						      <div class="list">
							       <div class="left"></div>
								   <div class="center"><a href="info.php?id=<?php echo $classList[$i]['id'];?>"><?php echo $classList[$i]['title'];?></a></div>
								   <div class="right"></div>
							  </div>
							<?php
								}//end loop
