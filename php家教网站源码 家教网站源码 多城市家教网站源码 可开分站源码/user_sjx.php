...
if(!empty($_GET["act"]))
{
        $sql = "UPDATE bw_zxwdhf SET ifdl = 2 WHERE id = {$_GET['dlid']}";
		$bw->query($sql);
		$bw->msg('删除成功!');
}		
?>
...
<table width="724" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#C9C9C9">
    <tr>
      ...
      <td width="300" align="center" valign="middle" background="images/user_sjx_bt_bg.jpg">消息主题</td>
      <td width="94" align="center" valign="middle" background="images/user_sjx_bt_bg.jpg">留言时间</td>
      <td width="80" align="center" valign="middle" background="images/user_sjx_bt_bg.jpg">查看</td>
      <td width="80" align="center" valign="middle" background="images/user_sjx_bt_bg.jpg">管理</td>
    </tr>
    <?php
	  ...
	  $pageSize = 15;
	  $tbName   = 'bw_zxwdhf';
	  $where    = '1=1 and ifdl=1 and uid='.$_SESSION["userid"];
    ...
    ?>
    <tr>
      <td height="32" align="center" valign="middle" bgcolor="#FFFFFF"><?php
	  if($hyzxlist[$hyzxi]['xxlx']==1)
	  { 
	  echo "单条信息";
	  }else{
	  echo "群发信息";
	  ...
	  ?></td>
      <td align="center" valign="middle" bgcolor="#FFFFFF"><?php if($hyzxlist[$hyzxi]['username']==""){echo $_SESSION["hyusername"];}else{echo $hyzxlist[$hyzxi]['username'];} ;?></td>
      <td align="center" valign="middle" bgcolor="#FFFFFF">
	  <a href="user_sjxshow.php?id=<?php echo $hyzxlist[$hyzxi]['id'];?>"><?php echo $hyzxlist[$hyzxi]['title'] ;?></a>
	  <?php if($hyzxlist[$hyzxi]['ifyd']==1){echo "<font color='#FF6600'>(未查看)";}?></font></td>
      <td align="center" valign="middle" bgcolor="#FFFFFF"><?php echo date("Y-m-d",strtotime($hyzxlist[$hyzxi]['addtime']));?></td>
      <td align="center" valign="middle" bgcolor="#FFFFFF"><a href="user_sjxshow.php?id=<?php echo $hyzxlist[$hyzxi]['id'];?>">点击</a></td>
	...
	?>
	<tr>
      <td height="30" colspan="6" align="center" valign="middle" bgcolor="#FFFFFF">
