...
<div id="all_main_all">
	 ...
	 <div id="all_main_all_box">
	      <div id="all_main_all_box_left">
		       <div id="all_main_all_box_left_top">当前位置：文章中心<?php echo "&nbsp;>>&nbsp;".$newsTitle['className'];?></div>
			   <div id="all_main_all_box_left_mid">
			        <div id="dowmload_box">
					     <div id="title">
						  <div class="tltle_box" style="padding-left:20px; margin-right:160px;">文章标题</div>
			 ...
			 <?php
				  ...
				  $hyzxlist = $bw->selectPage("id, title, subTime", $tbName, $where, "id DESC", $pageSize);
			  ...
			  ?>
						  <tr>
							...
							<a href="articleshow.php?id=<?php echo $hyzxlist[$hyzxi]['id'] ;?>" target="_blank"><?php echo $hyzxlist[$hyzxi]['title'] ;?></a></td>
					...
					<div id="mid">
						 ...
						 <div id="dh">
						       <?php
								...
								$classList = $bw->selectMany("id,className","bw_articleclass"," id not in (4,12)","`id` ASC");
								//var_dump($classList);
								//exit;
							...
							?>
						      <div class="list">
							   <div class="left"></div>
							   <div class="center"><a href="article.php?sid=<?php echo $classList[$i]['id'];?>"><?php echo $classList[$i]['className'];?></a></div>
							   <div class="right"></div>
							  </div>
							<?php
								}//end loop
