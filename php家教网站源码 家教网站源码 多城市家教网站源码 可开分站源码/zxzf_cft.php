...
<li id="youd"><a href="zxzf_cft.php?acontent=<?php echo $_GET["acontent"]?>">财付通</a></li>
...
<div class="lijizf">
<form name="zfb" method="post" action="tenpay/index.php" target="_blank">
    <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="40" colspan="2" align="center" valign="middle"><div align="left"><strong>
          <?php 
  ...
  <br>
    <?php
	$classData = $bw->selectOnly('content' ,'bw_base', 'id = 19');
