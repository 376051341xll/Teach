                          ...
                          <tr>
							...
							//  echo $nian1;
                             for($nian=$xiao;$nian<$nian1;$nian++)
							  {
							  ?>
                              <option spry:hover="<?php echo $nian;?>"><?php echo $nian;?></option>
                              <?php
                              }
							  ?>
...
{  ?>
			  ...
			  ?>
                          ...
                          <tr>
                            ...
                            <td><input type="text" name="mqsf" id="mqsf" style="width:120px;">                              <span style="color:#F00">&nbsp;*</span></td>
...
{  ?>
			  ...
			  ?>
                          ...
                          <tr>
                            ...
                            <td height="25" colspan="5"><input name="zhuanye" type="text" class="tutor_input" id="zhuanye">
