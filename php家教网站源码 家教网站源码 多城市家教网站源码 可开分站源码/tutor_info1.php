...
function yanz()
{
	...
	if(document.getElementById("idcode").value.length<15)
	{	
	document.getElementById("idcode").focus();
	alert("请您输入正确的身份证或者护照");
	return false;
	}
			   ...
			   <div id="all_main_all_box_left_mid">
			        <div id="tutor_box">
				      <div id="title" style="width:670px; height:36px; padding:1px;">
					       <div style="width:635px; height:36px; background:#f4f4f4; padding-left:35px;"> <strong>新教员注册第三步: </strong><font color="#fe5d08">2.</font>填写详细个人信息</div>
					  </div>
					  <div id="tutor_box_center" style="width:668px; padding:1px; border:1px #f4f4f4 solid;">
					    <form action="tutor_infoto.php" onSubmit="return yanz()" method="post">
						...
						<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td width="120" height="40" align="right">真实姓名：</td>
                            <td colspan="5"><label>
...
{  ?>
			  ...
			  ?>
                          ...
                          <tr>
                            <td height="40" align="right">出生地省份：</td>
...
{  ?>
			  ...
			  ?>
                          ...
                          <tr>
                            <td height="40" align="right">专&nbsp;&nbsp;&nbsp;业：</td>
                            <td height="25" colspan="5"><input name="zhuanye" type="text" class="tutor_input" id="zhuanye" onKeyUp="value=value.replace(/[^\u4E00-\u9FA5]/g,'')">
                              <span style="color:#F00">&nbsp;*请中文相关专业统一填写“中文”</span></td>
                          </tr>
                          <tr>
                            <td height="40" align="right">身份证 / 护照：</td>
                            <td height="25" colspan="5"><input name="idcode" type="text" class="tutor_input" id="idcode"><span style="color:#F00">&nbsp;*(此项将严格保密，不对外公开)</span>
                           </td>
                          </tr>
                          <tr>
                            <td height="40" align="right">毕业 / 就读高校：</td>
                            <td height="25" colspan="5"><input name="xuexiao" type="text" class="tutor_inputs" id="xuexiao" style=" width:230px;"><span style="color:#F00">&nbsp;*</span></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td height="40" align="right"> <label>地&nbsp;&nbsp;&nbsp;址：</label></td>
                            <td colspan="5"><label>
                              <input name="address" type="text" class="tutor_inputs" id="address" style=" width:230px;">
                            </label><span style="color:#F00">&nbsp;*请填写您目前的住址，本站尽量提供您附近的家教信息</span></td>
                          </tr>
                          <tr>
